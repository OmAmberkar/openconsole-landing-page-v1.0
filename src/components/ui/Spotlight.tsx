  ...
  return (
    <motion.div
      ...
      className='flex flex-col lg:flex-row items-center justify-between gap-8
                ...
                shadow-black/50 overflow-hidden relative border-2 border-t-blue-700 border-x-0 border-b-0 shadow-[0_0_30px_rgba(59,130,246,0.3)] rounded-4xl'
    >
      ...
      <motion.div className='flex-1 max-w-2xl' variants={textVariants}>
        ...
        >
          Stop juggling tabs across distinct cloud providers. OpenConsole unifies your
          infrastructure —spanning AWS, GCP, and scalable for future integrations like Azure—into a
          single, secure pane of glass. Abstract away the complexity of native consoles, automate
          deployments with Flowise, and secure your accounts with mandatory MFA, all while AI
          optimizes your spend.
        </p>
      </motion.div>
