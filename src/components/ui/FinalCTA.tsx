...
export default function FinalCTA() {
  ...
  return (
    <section className='py-20 md:py-24 w-full  relative z-10 overflow-hidden bg-blue-950/30 border-2 border-x-blue-600 border-y-0 shadow-[0_0_30px_rgba(59,130,246,0.3)] md:rounded-full rounded-4xl'>
      ...
      >
        ...
        >
          ...
          >
            <button
              className='group w-full md:w-auto px-10 py-3.5 rounded-full bg-linear-to-r from-blue-600 to-blue-500 text-white font-bold shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50 transition-all duration-300 flex items-center justify-center gap-2'
              onClick={playClick}
            >
          ...
          <a
            ...
            target='_blank'
            rel='noreferrer'
            className='group w-full md:w-auto px-10 py-3.5 rounded-full border border-neutral-700 bg-neutral-800/70 text-neutral-300 font-medium hover:bg-neutral-700 hover:text-white transition-all duration-300 flex items-center justify-center gap-2 no-underline'
            onClick={playClick}
          >
